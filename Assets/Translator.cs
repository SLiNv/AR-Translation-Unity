    ...
    public class Translator
    {
        ...
        #region Public methods
                 ...
                 string targetLanguage)
            {
                ...
                //System.Web.HttpUtility hUtillity = new System.Web.HttpUtility();
                ...
                try {
                    ...
                    string url = string.Format ("https://translate.googleapis.com/translate_a/single?client=gtx&sl={0}&tl={1}&dt=t&q={2}",
                                                ...
                                                System.Net.WebUtility.UrlEncode(sourceText));
                    ...
                    if (File.Exists (outputFile)) {
                        ...
                        this.TranslationSpeechUrl = string.Format ("https://translate.googleapis.com/translate_tts?ie=UTF-8&q={0}&tl={1}&total=1&idx=0&textlen={2}&client=gtx",
                                                                   System.Net.WebUtility.UrlEncode(translation), Translator.LanguageEnumToIdentifier (targetLanguage), translation.Length);
        ...
        #region Private methods
            ...
            private static void EnsureInitialized()
            {
                if (Translator._languageModeMap == null) {
                    ...
                    Translator._languageModeMap.Add ("Auto",      "auto");
